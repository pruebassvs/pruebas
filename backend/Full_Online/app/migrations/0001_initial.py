    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.deliverystatustype')),
                ('purchase', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.purchase')),
            ],
            options={
