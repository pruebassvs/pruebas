...
class DeliveryService:
    ...
    def update_delivery_status_with_history(purchase, status_description):
        try:
            ...
            new_status, created = DeliveryStatusType.objects.get_or_create(description=status_description)
            ...
            delivery_history = DeliveryHistory.objects.filter(delivery=delivery).order_by('-change_date')
