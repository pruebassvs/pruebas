...
import { AuthService } from '../../../services/auth-service/auth.service';import { FormsModule } from '@angular/forms';
...
export class RandomProductComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.productService.getRandomProductExcluding().subscribe(
