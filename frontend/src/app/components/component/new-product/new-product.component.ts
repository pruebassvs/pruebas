...
import { NewProduct, ShoeModelType, BrandType, SizeType, ColorType } from '../../../types/types';
...
constructor(private productService: ProductService, private formBuilder: FormBuilder,
  ...
  loadOptions(): void {
    this.productService.getShoeModels().subscribe(models => this.shoeModels = models);
